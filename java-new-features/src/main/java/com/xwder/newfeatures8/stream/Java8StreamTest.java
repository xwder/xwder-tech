package com.xwder.newfeatures8.stream;
...
public class Java8StreamTest {
    public static void main(String args[]) {
        ...
        OptionalInt optionalInt = integers.stream().mapToInt(x -> x).reduce((x, y) -> (Math.max(x, y)));
        Optional<Integer> maxOptional = integers.stream().max(Comparator.comparingInt(Integer::intValue).reversed());
        System.out.println(maxOptional.orElse(0));
        System.out.println(optionalInt.getAsInt());
        System.out.println(optionalInt.orElse(10));
